...
public enum CountryCode {
     ...
     * @see #ZR
     */
    CD("Congo DRC", "COD", 180, Assignment.OFFICIALLY_ASSIGNED),
     ...
     * Officially assigned]
     *
     * Frond-end uses Congo-Brazzaville as an official name
     */
    CG("Congo-Brazzaville", "COG", 178, Assignment.USER_ASSIGNED),
     ...
     * Officially assigned]
     *
     * Front-end uses Ivory Coast as an official name
     */
    CI("Ivory Coast", "CIV", 384, Assignment.USER_ASSIGNED),
     ...
     * Officially assigned]
     */
    GN("Guinea-Conakry", "GIN", 324, Assignment.USER_ASSIGNED),
     ...
     * Officially assigned]
     *
     * Front-end uses St Kitts and Nevis as an official name
     */
    KN("St Kitts and Nevis", "KNA", 659, Assignment.USER_ASSIGNED),
     ...
     * Officially assigned]
     *
     * Front-end uses Laos as an official name
     */
    LA("Laos", "LAO", 418, Assignment.USER_ASSIGNED),
     ...
     * Officially assigned]
     * Front-end uses St Lucia as an official name
     */
    LC("St Lucia", "LCA", 662, Assignment.USER_ASSIGNED),
     ...
     * Officially assigned]
     *
     * Front-end uses Moldova as an official name
     */
    MD("Moldova", "MDA", 498, Assignment.USER_ASSIGNED),
    ...
    /**
     * <a href="https://en.wikipedia.org/wiki/Somaliland">Somaliland</a>
     * Country without ISO code
     *
     * Front-end uses Somaliland as an official name with SS as code according to WR-801
     */
    SS("Somaliland", "SOM", 10000, Assignment.USER_ASSIGNED),
     ...
     * Officially assigned]
     *
     * Front-end doesn't have South Sudan, see WR-550 and related bugs
     */
     ...
     * Officially assigned]
     *
     * Front-end uses Turks and Caicos as an official name
     */
    TC("Turks and Caicos", "TCA", 796, Assignment.USER_ASSIGNED),
     ...
     * Officially assigned]
     *
     * Front-end uses Tanzania as an official name
     */
    TZ("Tanzania", "TZA", 834, Assignment.USER_ASSIGNED),
     ...
     * Officially assigned]
     *
     * Front-end uses St Vincent Grenadines as an official name
     */
    VC("St Vincent Grenadines", "VCT", 670, Assignment.USER_ASSIGNED),
     ...
     * Officially assigned]
     *
     * Front-end uses Vietnam as an official name
     */
    VN("Vietnam", "VNM", 704, Assignment.USER_ASSIGNED),
    ...
    /**
     * Get the country name in given TranslationLanguage
     *
     * @return The country name in given TranslationLanguage
     */
    public String getName(TranslationLanguage language) {
        val bundlePath = String.format("i18n/common/countries/CountryNames");
        val result = ResourceBundle.getBundle(bundlePath, language.getLocale());
        return result.getString(this.toString());
    }
    ...
    /**
     * Get a {@code CountryCode} instance by its name {@link #name}
     *
     * @param name of country listed in {@code CountryCode}
     *
     * @throws IllegalArgumentException in case country with provided name is not present in {@code CountryCode}
     */
    public static CountryCode getCountryByName(String name) {
        return CountryCode.findByName(name).stream().findFirst()
                .orElseThrow(() -> new IllegalArgumentException(format("There's no such country '%s'", name)));
    }
